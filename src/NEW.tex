...
The NEW detector, shown in figure \ref{fig:NewOverview} is the first stage of the NEXT experiment. The NEW pressure vessel (NPV) and field cage
...
\begin{figure}[hpt!]
    ...
    \begin{center}\leavevmode
        \rotatebox{0}{
        \includegraphics[width=.8\textwidth]{TrackingPlane/IMG/Simple.pdf}}
...
\begin{figure}[hpt!]
\centering
\includegraphics[width=.45\textwidth]{TrackingPlane/IMG/external_cabling2}
\includegraphics[width=.45\textwidth]{TrackingPlane/IMG/cabling2FEE}
\includegraphics[width=.45\textwidth]{TrackingPlane/IMG/cabling_under_platform}
